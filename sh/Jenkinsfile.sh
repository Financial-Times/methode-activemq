...
ssh -o StrictHostKeyChecking=no -i ~/.ssh/jenkins_id_rsa ${DNS_NAME} "cd /opt/methode/methode-activemq && sudo git pull && sudo ./pipeline.sh --debug=true --checkout=${BRANCHNAME}"
